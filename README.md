...
(4) Open in the browser: `http://localhost/unit-rates/unit-rates_en.html`
...
(3) Open in the
browser: `http://localhost/unit-rates/build/adapted-from-phet/unit-rates_en_adapted-from-phet.html`
