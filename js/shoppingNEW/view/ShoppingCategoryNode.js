...
define( function( require ) {
   ...
   * @constructor
   */
  function ShoppingCategoryNode( category, categoryProperty, layoutBounds, options ) {
    ...
    category.shoppingItems.forEach( function( shoppingItem ) {
      self.addChild( new ShoppingItemNode( shoppingItem, category.shoppingItemProperty, layoutBounds ) );
    } );
