...
define( function( require ) {
  ...
  var OLDQuestionAnswer = require( 'UNIT_RATES/old/common/model/OLDQuestionAnswer' );
   ...
   * @constructor
   */
  function OLDChallenges( itemDataProperty, onCorrectAnswer, onRefresh ) {
  ...
  unitRates.register( 'OLDChallenges', OLDChallenges );

  return inherit( Object, OLDChallenges, {
    ...
    selectQuestionSet: function() {
      ...
      do {
        //TODO magic number
        questionSet = phet.joist.random.nextInt( 4 );  // 4 sets of data available - see OLDItemType.challengeData
      }
     ...
     *
     * @param {OLDItemData} itemData - the type and rate used to generate questions
     * @private
     */
    generateQuestionsAnswersForItem: function( itemData ) {
      ...
      if ( itemType === OLDItemData.RED_CANDY.type || itemType === OLDItemData.PURPLE_CANDY.type ||
           itemType === OLDItemData.GREEN_CANDY.type || itemType === OLDItemData.BLUE_CANDY.type ) {

        // Q: Unit rate
        var candyItem1 = new OLDItem( itemData, 1 );
        var candyAnswerText1 = StringUtils.format( '{0}{1}', currencySymbolString, Util.toFixed( itemRate, 2 ) );//TODO i18n
        var c1 = new OLDQuestionAnswer( candyItem1, itemRate, candyAnswerText1, {
        ...
        var costOfCandyQuestionString2 = StringUtils.format( costOfNUnitsString, candyItem2.countProperty.value, poundsString );
        var c2 = new OLDQuestionAnswer( candyItem2, candyCost2, candyAnswerText2, {
        ...
        var costOfCandyQuestionString3 = StringUtils.format( costOfNUnitsString, candyItem3.countProperty.value, poundsString );
        var c3 = new OLDQuestionAnswer( candyItem3, candyCost3, candyAnswerText3, {
        ...
        var costOfCandyQuestionString4 = StringUtils.format( costOfNUnitsString, candyItem4.countProperty.value, poundsString );
        var c4 = new OLDQuestionAnswer( candyItem4, candyCost4, candyAnswerText4, {
        ...
        // Q: Unit rate
        var item1 = new OLDItem( itemData, 1 );
        var itemAnswerText1 = StringUtils.format( '{0}{1}', currencySymbolString, Util.toFixed( itemRate, 2 ) );
        var i1 = new OLDQuestionAnswer( item1, itemRate, itemAnswerText1, {
          questionString: unitRateQuestionString,
        ...
        var costOfItemQuestionString2 = StringUtils.format( costOfNUnitsString, item2.countProperty.value, pluralName );
        var i2 = new OLDQuestionAnswer( item2, itemCost2, itemAnswerText2, {
        ...
        var costOfItemQuestionString3 = StringUtils.format( costOfNUnitsString, item3.countProperty.value, pluralName );
        var i3 = new OLDQuestionAnswer( item3, itemCost3, itemAnswerText3, {
        ...
        var i4 = new OLDQuestionAnswer( item4, item4.countProperty.value, itemAnswerText4, {
     ...
     *
     * @return {Array.<OLDQuestionAnswer>}
     * @public
     */
    ...
    getPromptItem: function( itemData, setNumber, promptNumber ) {
      ...
      return new OLDItem( itemData.type, count );
    },
