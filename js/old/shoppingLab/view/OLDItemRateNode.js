...
define( function( require ) {
   ...
   * @constructor
   */
  function OLDItemRateNode( itemTypeProperty, itemRateProperty, options ) {
    ...
    this.itemPickerData = [
      {
        ...
        countString: OLDItemData.APPLES.pluralName,
        visible: true
      }, {
        // CARROTS_INDEX
        ...
        countString: OLDItemData.CARROTS.pluralName,
        visible: false
      }, {
        // CANDY_INDEX
    ...
    // @private
    this.unitText = new Text( OLDItemData.APPLES.pluralName, {
    ...
    AccordionBox.call( this, this.contentNode, {
      ...
      buttonXMargin: 15,
      buttonYMargin: 15,
      titleNode: new Text( rateString, { font: OLDURConstants.PANEL_TITLE_FONT, maxWidth: 100 } ),
      titleAlignX: 'left',
  ...
  unitRates.register( 'OLDItemRateNode', OLDItemRateNode );

  return inherit( AccordionBox, OLDItemRateNode, {
