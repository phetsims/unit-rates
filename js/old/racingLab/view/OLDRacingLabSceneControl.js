...
define( function( require ) {
   ...
   * @constructor
   */
  function OLDRacingLabSceneControl( trackCountProperty, options ) {

    options = _.extend( {

      // OLDRacingLabSceneControl options
      buttonWidth: 68,
  ...
  unitRates.register( 'OLDRacingLabSceneControl', OLDRacingLabSceneControl );
  ...
  return inherit( RadioButtonGroup, OLDRacingLabSceneControl );
} );