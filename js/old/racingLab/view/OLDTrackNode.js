...
define( function( require ) {
  ...
  // sim modules
  var OLDFinishFlagNode = require( 'UNIT_RATES/old/racingLab/view/OLDFinishFlagNode' );
  var OLDTimerDisplayNode = require( 'UNIT_RATES/old/racingLab/view/OLDTimerDisplayNode' );
   ...
   * @constructor
   */
  function OLDTrackNode( model, carImageName, options ) {
    ...
    this.finishFlagNode = new OLDFinishFlagNode( this.finishPoint,
    ...
    // timer
    this.timer = new OLDTimerDisplayNode( {
      centerX: this.finishPoint.x,
      bottom: this.finishFlagNode.top - OLDURConstants.PANEL_SPACING / 2,
  ...
  unitRates.register( 'OLDTrackNode', OLDTrackNode );

  return inherit( Node, OLDTrackNode, {
