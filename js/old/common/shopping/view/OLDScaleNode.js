...
define( function( require ) {
   ...
   * @constructor
   */
  function OLDScaleNode( scale, itemLayer, startMoveCallback, endMoveCallback, options ) {
  ...
  unitRates.register( 'OLDScaleNode', OLDScaleNode );

  return inherit( Node, OLDScaleNode, {
    ...
    itemDataChanged: function( itemData ) {
      ...
      var isFruit = ( itemType === OLDItemData.APPLES.type || itemType === OLDItemData.LEMONS.type ||
                      itemType === OLDItemData.ORANGES.type || itemType === OLDItemData.PEARS.type );
      ...
      var itemNode = OLDItemNodeFactory.createItemNode( new OLDItem( itemType, ( isFruit ? 1 : 2 ) ) );
