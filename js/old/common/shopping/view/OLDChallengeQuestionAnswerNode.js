...
define( function( require ) {
  ...
  /**
   * @param {OLDQuestionAnswer} qna
   * @param {NumberKeypad} keypad - shared keypad node
   * @param {Object} [options]
   * @constructor
   */
  function OLDChallengeQuestionAnswerNode( qna, keypad, options ) {
    ...
    this.editNumberDisplay = new OLDEditNumberDisplayNode( keypad, qna.valueProperty, pattern, {
  ...
  unitRates.register( 'OLDChallengeQuestionAnswerNode', OLDChallengeQuestionAnswerNode );

  return inherit( Node, OLDChallengeQuestionAnswerNode, {
