...
define( function( require ) {
  ...
  // sim modules
  var OLDEditNumberDisplayNode = require( 'UNIT_RATES/old/common/view/OLDEditNumberDisplayNode' );
  ...
  /**
   * @param {OLDURNumberLineMarker} marker
   * @param {Vector2} position - (x,y) position on the number line
   * @param {OLDKeypadPanelNode} keypad - shared keypad
   ...
   * @constructor
   */
  function OLDURNumberLineMarkerNode( marker, position, keypad, updateFunction, options ) {
    ...
    // @protected - top label
    this.topNumberDisplay = new OLDEditNumberDisplayNode( keypad, this.marker.topQnA.valueProperty, options.topPattern, {
      centerX: -2,
    ...
    this.bottomNumberDisplay = new OLDEditNumberDisplayNode( keypad, this.marker.bottomQnA.valueProperty, options.bottomPattern, {
      centerX: -2,
    ...
    OLDMovableNode.call( this, marker, position, options );
  ...
  unitRates.register( 'OLDURNumberLineMarkerNode', OLDURNumberLineMarkerNode );

  return inherit( OLDMovableNode, OLDURNumberLineMarkerNode, {
    ...
    dispose: function() {
      ...
      OLDMovableNode.prototype.dispose.call( this );
    }
