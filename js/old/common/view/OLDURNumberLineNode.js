...
define( function( require ) {
  ...
  var OLDURNumberLineMarkerNode = require( 'UNIT_RATES/old/common/view/OLDURNumberLineMarkerNode' );
  ...
  /**
   * @param {OLDURNumberLine} numberLine - model
   * @param {OLDKeypadPanelNode} keypad - shared keypad
   * @param {Object} [options]
   * @constructor
   */
  function OLDURNumberLineNode( numberLine, keypad, options ) {
    ...
    AccordionBox.call( this, this.contentNode, {
      ...
      buttonXMargin: 15,
      buttonYMargin: 15,
      titleNode: new Text( options.numberLineTitle, { font: OLDURConstants.PANEL_TITLE_FONT } ),
      titleAlignX: 'left',
  ...
  unitRates.register( 'OLDURNumberLineNode', OLDURNumberLineNode );

  return inherit( AccordionBox, OLDURNumberLineNode, {
     ...
     *
     * @param {OLDURNumberLineMarkerNode} markerNode
     * @public
     */
     ...
     *
     * @returns {Array}.<OLDURNumberLineMarkerNode>
     * @public
     */
     ...
     * @return {OLDURNumberLineMarkerNode}
     * @private
     */
    createMarkerNode: function( marker ) {
      ...
      markerNode = new OLDURNumberLineMarkerNode( marker, position, this.keypad, this.updateMarkerNode.bind( this ), {
        draggable: false,
        centerX: position.x,
        centerY: position.y,
        color: marker.color,
