...
define( function( require ) {
   ...
   * @constructor
   */
  function OLDEditNumberDisplayNode( keypad, valueProperty, pattern, options ) {

    options = _.extend( {
      numberRange: new Range( 0, 200 ),   // valid range for the number display
    ...
    if ( options.buttonPosition === 'left' ) {
      ...
      assert && assert( false, 'invalid buttonPosition for OLDEditNumberDisplayNode' );
    }
  ...
  unitRates.register( 'OLDEditNumberDisplayNode', OLDEditNumberDisplayNode );

  return inherit( Node, OLDEditNumberDisplayNode, {
    ...
    showKeypad: function() {
      ...
      // Set keypad listeners to this instance of the OLDEditNumberDisplayNode
