...
define( function( require ) {
   ...
   * @constructor
   */
  function OLDURNumberLineMarker( correctTopValue, correctBottomValue, rateProperty, options ) {
    ...
    OLDMovable.call( this, options );

    // @public
    this.topQnA = new OLDQuestionAnswer( this, correctTopValue, correctTopValue );
    this.bottomQnA = new OLDQuestionAnswer( this, correctBottomValue, correctBottomValue );
  ...
  unitRates.register( 'OLDURNumberLineMarker', OLDURNumberLineMarker );

  return inherit( OLDMovable, OLDURNumberLineMarker, {

    // @public
    reset: function() {

      OLDMovable.prototype.reset.call( this );
    ...
    dispose: function() {
      ...
      OLDMovable.prototype.dispose.call( this );
