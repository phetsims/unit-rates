...
define( function( require ) {
  ...
  // sim modules
  var OLDURNumberLineMarker = require( 'UNIT_RATES/old/common/model/OLDURNumberLineMarker' );
   ...
   * @constructor
   */
  function OLDURNumberLine( rateProperty, topMaxProperty, bottomMaxProperty, options ) {
  ...
  unitRates.register( 'OLDURNumberLine', OLDURNumberLine );

  return inherit( Object, OLDURNumberLine, {
    ...
    createMarker: function( correctTopValue, correctBottomValue, options ) {
      ...
      var marker = new OLDURNumberLineMarker( correctTopValue, correctBottomValue, this.rateProperty, options );
